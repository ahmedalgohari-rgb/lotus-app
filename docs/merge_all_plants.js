 ...
 * - Preserves all 135 existing plants WITH image URLs
 * - Adds ~396 new plants from batches 1-14 (duplicates already removed)
 */
...
console.log('🌿 Merging plant databases...\n');
...
console.log(`   2. Rename to database_complete_detailed.csv (replace original)`);
